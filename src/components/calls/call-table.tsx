...
const getSentimentBadgeVariant = (sentiment: CallSentiment) => {
  switch (sentiment) {
    case "positive":
      return "default";
    case "negative":
        ...
        <TableBody>
          {calls.map((call) => (
            ...
            >
              ...
              <TableCell>
                <Badge variant={getOutcomeBadgeVariant(call.outcome as CallOutcome)} className="font-medium">
                  {formatOutcome(call.outcome)}
                </Badge>
              </TableCell>
              <TableCell>
                <Badge variant={getSentimentBadgeVariant(call.sentiment as CallSentiment)} className="font-medium">
