...
function Sidebar({
  ...
  React.useEffect(() => {
    if (!isMobile && state === "collapsed" && isHovered && collapsible === "icon") {
      setOpen(true)
    }
  }, [isHovered, state, isMobile, collapsible, setOpen])
  
  // Collapse sidebar when mouse leaves (with delay)
  React.useEffect(() => {
    if (!isMobile && state === "expanded" && !isHovered && collapsible === "icon") {
